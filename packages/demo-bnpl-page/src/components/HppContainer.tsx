          ...
          <Box>
            ...
            <Box display="grid" gap="spacing2">
              <Box display="flex" width="100%" border="accent_border_interactive" alignItems="center" paddingY="spacing1" paddingLeft="spacing1" paddingRight="spacing3">
                <Box borderRadius="50%" border="accent_nonInteractive" width="spacing5" height="spacing5" display="flex" alignItems="center" justifyContent="center" marginRight="spacing1"><Icon icon={faUniversity} /></Box>
                {/* <Box><NatwestLogo/></Box>  */}
                <Box width="100%">
